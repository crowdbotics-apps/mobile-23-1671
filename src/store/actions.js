...
export const newplugin231_get__read = new_param => ({
  type: types.NEWPLUGIN231_GET__READ,
  new_param
})

export const newplugin231_get__readSucceeded = response => ({
  type: types.NEWPLUGIN231_GET__READ_SUCCEEDED,
  response
})

export const newplugin231_get__readFailed = error => ({
  type: types.NEWPLUGIN231_GET__READ_FAILED,
  error
})
